...
(
    ...
    ) ENGINE = InnoDB AUTO_INCREMENT = 578295 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '操作审计日志表' ROW_FORMAT = DYNAMIC;
...
(
    ...
    ) ENGINE = InnoDB AUTO_INCREMENT = 17114 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '游戏服务器实体表' ROW_FORMAT = DYNAMIC;
...
(
    ...
    ) ENGINE = InnoDB AUTO_INCREMENT = 1089 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci ROW_FORMAT = Dynamic;
...
(
    ...
    ) ENGINE = InnoDB AUTO_INCREMENT = 72958141 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci ROW_FORMAT = Dynamic;
...
(
    ...
    ) ENGINE = InnoDB AUTO_INCREMENT = 100 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '用户关注表' ROW_FORMAT = DYNAMIC;
